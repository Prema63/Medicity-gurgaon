...
export default function Rooms() {
    ...
    const [premierImage, setPremierImage] = useState("https://node.bluokolkata.com/get/files/mca2l276-mo2fb-Screenshot 2025-06-17 154757.png");
    const [superiorImage, setSuperiorImage] = useState("https://node.bluokolkata.com/get/files/m8a49kdn-v8oim-first-BWpEh84X.jpg");
    const [juniorSuiteImage, setJuniorSuiteImage] = useState("https://node.bluokolkata.com/get/files/m8a4bn5f-7ra8l-first-DxhYexmo.jpg");
    ...
    return (
        <>
            <div className="w-full shadow-md min-h-screen">
                ...
                {/* Main Content */}
                <div className="container mx-auto px-3 py-8 flex flex-col lg:flex-row gap-8">
                    {/* Left Section */}
                        ...
                        <div className="container px-3 py-8">
                            ...
                            <div className="flex flex-col lg:flex-row gap-8 mb-12">
                                <div className="w-full lg:w-1/2">
                                    ...
                                    <div className="flex justify-center mt-4">
                                        <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-lg shadow-sm cursor-pointer">
                                            <img
                                                src="https://node.bluokolkata.com/get/files/mca2l276-mo2fb-Screenshot 2025-06-17 154757.png"
                                                alt="Thumbnail 1"
                                                className="w-12 h-12 object-cover rounded"
                                                onClick={() => setPremierImage("https://node.bluokolkata.com/get/files/mca2l276-mo2fb-Screenshot 2025-06-17 154757.png")}
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col lg:flex-row gap-8 mb-12">
                                <div className="w-full lg:w-1/2">
                                    ...
                                    <div className="flex justify-center mt-4 gap-2">
                                        {[
                                            "m8a49kdn-v8oim-first-BWpEh84X.jpg",
                                            "m8a49kex-zp1oq-third-CG5nY3Ek.jpg",
                                            "m8a49kfq-fzp3d-fourth-Dy23iPzr.jpg",
                                            "m8a49kg8-otehc-second-68QeEQBF.jpg",
                                        ].map((img, i) => (
                                            <div
                                                key={i}
                                                className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-lg shadow-sm cursor-pointer"
                                            >
                                                <img
                                                    src={`https://node.bluokolkata.com/get/files/${img}`}
                                                    alt={`Thumbnail ${i + 1}`}
                                                    className="w-12 h-12 object-cover rounded"
                                                    onClick={() => setSuperiorImage(`https://node.bluokolkata.com/get/files/${img}`)}
                                                />
                                            </div>
                                        ))}
                                    </div>
                            ...
                            <div className="flex flex-col lg:flex-row-reverse gap-8">
                                <div className="w-full lg:w-1/2">
                                    ...
                                    <div className="flex justify-center mt-4 gap-2">
                                        {[
                                            "m8a4bn5f-7ra8l-first-DxhYexmo.jpg",
                                            "m8a4bn65-id0nw-third-DoQLkKvU.jpg",
                                            "m8a4bn7b-si4pm-fourth-aWwDDidy.jpg",
                                            "m8a4bn7t-bp5c0-first-Cs72WZfF.jpg",
                                        ].map((img, i) => (
                                            <div
                                                key={i}
                                                className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-lg shadow-sm cursor-pointer"
                                            >
                                                <img
                                                    ...
                                                    alt={`Thumbnail ${i + 1}`}
                                                    className="w-12 h-12 object-cover rounded"
                                                    onClick={() => setJuniorSuiteImage(`https://node.bluokolkata.com/get/files/${img}`)}
                                                />
                                            </div>
                                        ))}
                                    </div>
